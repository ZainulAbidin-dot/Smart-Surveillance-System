...
export class CreateAccessLinkController extends BaseController {
  private useCase: CreateAccessLinkUseCase;

  constructor(useCase: CreateAccessLinkUseCase) {
    super();
  ...
  async executeImpl(request: any, response: any): Promise<any> {
    ...
    const dto: CreateAccessLinkDTO = payload;
